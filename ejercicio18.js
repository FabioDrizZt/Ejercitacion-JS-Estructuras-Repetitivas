...
function calcularPorcentajesEstudios(datos) {
    // Tu código aquí
    // Debe retornar un objeto con los porcentajes de cada nivel
    // {primario: x%, secundario: y%, universitario: z%, ...}
}

module.exports = {
    calcularPorcentajesEstudios
};
